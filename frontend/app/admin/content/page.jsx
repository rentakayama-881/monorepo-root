  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-[rgb(var(--fg))]">Hidden Content</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[rgb(var(--border))]">
                <th className="text-left py-3 px-4 font-medium text-[rgb(var(--muted))]">Type</th>
                <th className="text-left py-3 px-4 font-medium text-[rgb(var(--muted))]">Content ID</th>
                <th className="text-left py-3 px-4 font-medium text-[rgb(var(--muted))]">Reason</th>
                <th className="text-left py-3 px-4 font-medium text-[rgb(var(--muted))]">Hidden By</th>
                <th className="text-left py-3 px-4 font-medium text-[rgb(var(--muted))]">Hidden At</th>
                <th className="text-right py-3 px-4 font-medium text-[rgb(var(--muted))]">Actions</th>
              </tr>
            </thead>
            <tbody>
              {contents.map((content) => (
                <tr key={content.id} className="border-b border-[rgb(var(--border))] hover:bg-[rgb(var(--surface-2))]">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-[rgb(var(--surface))] rounded-xl max-w-md w-full">
            <div className="p-6 border-b border-[rgb(var(--border))]">
              <h2 className="text-xl font-semibold text-[rgb(var(--fg))]">Hide Content</h2>
            </div>
