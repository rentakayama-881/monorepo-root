...
function normalizeDispute(item) {
  return {
    ...
    phaseDeadline: item?.phaseDeadline ?? item?.PhaseDeadline ?? item?.phase_deadline ?? null,
  };
}
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <ol className="list-decimal list-inside space-y-1">
                <li>
                  <strong>Negotiation</strong> - Discuss with the counterparty (24 hours)
                </li>
                <li>
                  <strong>Evidence</strong> - Upload supporting evidence (48 hours)
                </li>
                <li>
                  <strong>Admin Review</strong> - Our team will decide
                </li>
              </ol>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-muted-foreground">
              {activeTab === "active" ? "No active disputes" : "No dispute history yet"}
            </div>
          </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground mb-2">{dispute.reason}</div>
                    <div className="flex items-center gap-4 text-xs text-muted-foreground">
                      <span>Rp {dispute.amount?.toLocaleString("id-ID") || 0}</span>
                      <span>•</span>
