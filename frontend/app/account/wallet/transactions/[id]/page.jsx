                  ...
                  <div className="text-sm text-muted-foreground">
                    {isSender ? (
                      <>
                        ...
                        <br />
                        <strong>Need help?</strong> You can cancel the transaction or request
                      ...
                      <>
                        ...
                        <br />
                        <br />
                        <strong>Encountering an issue?</strong> You can request support from our
                        mediation team.
                      </>
                    )}
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-sm rounded-lg bg-card p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              {pendingAction === "reject" &&
                "Enter PIN to reject transfer and return funds to sender"}
            </p>
          ...
          <div className="w-full max-w-sm rounded-lg bg-card p-6">
            ...
            <div className="text-sm text-muted-foreground mb-6 text-center space-y-2">
              ...
              <ol className="text-xs text-left list-decimal list-inside space-y-1">
                ...
                <li>
                  Then click <strong>Send Funds</strong> or <strong>Withdraw Funds</strong> to
                  configure your PIN
                </li>
              </ol>
            </div>
