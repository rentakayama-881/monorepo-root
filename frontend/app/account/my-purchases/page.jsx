  ...
  return (
    <main className="container py-8 space-y-4">
      <header className="space-y-1">
        <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-muted-foreground">Akun</div>
        <h1 className="text-2xl font-semibold text-foreground">My Purchase</h1>
        <p className="text-sm text-muted-foreground">Riwayat pembelian akun kamu ada di sini.</p>
      </header>

      <section className="rounded-xl border border-border bg-card p-3">
        {loading ? <p className="text-sm text-muted-foreground">Memuat riwayat pembelian...</p> : null}
