...
export default async function sitemap() {
  ...
  const categories = ["coding", "riset-ilmiah", "tugas-kuliah", "dokumen", "ui-ux", "keamanan"];
    ...
    if (res.ok) {
      ...
      casePages = cases.map((vc) => ({
        ...
        lastModified: vc.updated_at
          ? new Date(typeof vc.updated_at === "number" ? vc.updated_at * 1000 : vc.updated_at)
          : new Date(),
        changeFrequency: "weekly",
        priority: 0.6,
      }));
