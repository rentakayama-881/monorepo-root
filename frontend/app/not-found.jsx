...
export const metadata = {
  ...
  description: "Halaman yang Anda minta tidak dapat ditemukan.",
  robots: {
    index: false,
    follow: false,
  },
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-2xl">
        ...
        <h1
          className="text-3xl sm:text-4xl font-bold text-foreground mb-4 animate-slide-up"
        ...
        <div className="mb-8 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          <div className="max-w-md mx-auto">
            <SearchInput placeholder="Cari halaman yang Anda butuhkan..." />
          </div>
        </div>
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:scale-105 hover:shadow-xl hover:shadow-primary/30"
          >
            <svg
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
            <Link
              ...
              className="group rounded-lg border border-border p-3 transition-all hover:border-primary hover:bg-primary/5"
            >
