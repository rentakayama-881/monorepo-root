      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            ...
            className="inline-flex justify-center items-center rounded-lg border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-accent transition"
          >
            Hubungi Kami
          </Link>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-border">
          <p className="text-sm text-muted-foreground mb-4">Mungkin Anda mencari:</p>
