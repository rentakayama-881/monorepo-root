...
import { ChevronLeft, Plus, FileText, File, Download, Trash2, X, CloudUpload } from "lucide-react";
...
export default function DocumentsPage() {
  ...
  const [showUploadModal, setShowUploadModal] = useState(autoUpload);
        ...
        <div className="bg-card rounded-xl border border-border p-4 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-muted-foreground">
              {statsLoading
                ? "..."
                : `${formatFileSize(stats.totalSize)} / ${formatFileSize(stats.maxSize)}`}
            </span>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <NativeSelect
                    ...
                    onChange={(e) =>
                      setUploadForm((prev) => ({ ...prev, visibility: e.target.value }))
                    }
                    className="h-10 rounded-lg bg-background"
                  >
