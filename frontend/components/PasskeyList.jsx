...
function getTransportLabel(transports) {
  if (!transports || transports.length === 0) return "Tidak diketahui";
  if (transports.includes("internal")) return "Autentikator bawaan";
  if (transports.includes("usb")) return "Kunci keamanan USB";
      ...
      {passkeys.map((pk) => (
        ...
        >
          <div className="flex items-center gap-3">
            <span className="text-muted-foreground" title={getTransportLabel(pk.transports)}>
