...
/**
 * Legal/Policy Page Icons - Clean SVG icons matching ProfileSidebar style
 * Consistent with passkey icons: h-4 w-4, stroke-based, strokeWidth 2
 */
...
// Shield icon for security/privacy items
...
// Lock icon for data protection items
...
// Scale/Balance icon for rules/terms
export function ScaleIcon({ className = "h-4 w-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Server icon for infrastructure
export function ServerIcon({ className = "h-4 w-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Eye icon for visibility/access
...
// Download icon for data portability
...
// MessageCircle icon for support
...
// HelpCircle icon
export function HelpCircleIcon({ className = "h-4 w-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
...
export function ZapIcon({ className = "h-4 w-4" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
