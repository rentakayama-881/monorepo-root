...
describe("format.js", () => {
  ...
  describe("formatDate", () => {
    ...
    it("should handle Unix seconds from Go backend", () => {
      // 1741363200 = March 7, 2025 in Unix seconds
      const result = formatDate(1741363200);
      expect(result).not.toBe("-");
      expect(result).not.toContain("1970");
    });

    it("should handle Unix milliseconds", () => {
      // 1741363200000 = March 7, 2025 in Unix milliseconds
      const result = formatDate(1741363200000);
      expect(result).not.toBe("-");
      expect(result).not.toContain("1970");
    });
  });
