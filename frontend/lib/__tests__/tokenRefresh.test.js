...
describe("tokenRefresh.js", () => {
  ...
  describe("getValidToken", () => {
    ...
    it("should retry 3x with backoff then clearToken if refresh fails", async () => {
      jest.useFakeTimers();
      ...
      const resultPromise = getValidToken();
  ...
  describe("fetchWithAuth", () => {
    ...
    it("should throw if not authenticated", async () => {
      ...
      await expect(fetchWithAuth("https://api.test.com/api/me")).rejects.toThrow(
        "Not authenticated"
      );
    });
