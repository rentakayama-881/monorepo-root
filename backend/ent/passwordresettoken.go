...
func (*PasswordResetToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case passwordresettoken.FieldCreatedAt, passwordresettoken.FieldUpdatedAt, passwordresettoken.FieldDeletedAt, passwordresettoken.FieldExpiresAt, passwordresettoken.FieldUsedAt:
