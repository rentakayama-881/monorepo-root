...
const (
	// Label holds the string label denoting the totppendingtoken type in the database.
	Label = "totp_pending_token"
	...
	EdgeUser = "user"
	// Table holds the table name of the totppendingtoken in the database.
	Table = "totp_pending_tokens"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "totp_pending_tokens"
...
// Columns holds all SQL columns for totppendingtoken fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the TOTPPendingToken queries.
