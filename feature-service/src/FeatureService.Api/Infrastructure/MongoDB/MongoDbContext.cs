        ...
        try
        {
            Transfers.Indexes.CreateOne(new CreateIndexModel<Transfer>(
                ...
                new CreateIndexOptions<Transfer>
                {
                    ...
                    PartialFilterExpression = MongoIndexFilters.PendingTransferCaseLockPartialFilter()
                }
            ));
        }
        catch (Exception ex)
        ...
        try
        {
            Withdrawals.Indexes.CreateOne(new CreateIndexModel<Withdrawal>(
                ...
                new CreateIndexOptions<Withdrawal>
                {
                    ...
                    PartialFilterExpression = MongoIndexFilters.ActiveWithdrawalByUserPartialFilter()
                }
            ));
        }
        catch (Exception ex)
